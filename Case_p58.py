...
C321 = openmc.Cell(cell_id=321, fill=M30, region=(+s7 &-s506 &+s600 &-s8)            )
C322 = openmc.Cell(cell_id=322, fill=M30, region=(+s7 &-s506 &+s9 &-s604)            )
# c ----------- water tanks -----------------------------------$
...
C414 = openmc.Cell(cell_id=414, fill=M7, region= (+s19 &-s8 &+s506 &-s23)|(+s8 &-s14 &-s23 &+s7)|(+s14 &-s18 &+s16 &-s23)|(+s17 &-s18 &-s6)|(+s18 &-s21 &-s23)) 
