...
###############################################################################
materials = openmc.Materials([M1, M3, M5, M6, M7, M8, M9, M10, M11, M12])
...
s81  = openmc.ZCylinder(surface_id=81, r=13.29055)
...
C107 = openmc.Cell(cell_id=107,fill=M12,region=(-s81 &+s7 &-s14 &+s19))
C108 = openmc.Cell(cell_id=108,fill=M7,region=(-s23 &+s81 &-s14 &+s19)|(-s23 &+s16 &-s18 &+s14)|(-s6 &-s18 &+s17)|(-s23 &-s21 &+s18))
C109 = openmc.Cell(cell_id=109,region=-s23 &-s22 &+s21)
C110 = openmc.Cell(cell_id=110,fill=M9,region=(-s24 &+s7 &-s19 &+s20)|(-s24 &+s23 &-s22 &+s19))

C111 = openmc.Cell(cell_id=111,fill=M12,region=(-s81 &+s7 &-s20 &+s15))
C112 = openmc.Cell(cell_id=112,fill=M7,region=(-s27 &-s15 &+s25)|(-s27 &+s81 &-s20 &+s15))
C113 = openmc.Cell(cell_id=113,fill=M9,region=(-s28 &-s25 &+s26)|(-s28 &+s27 &-s20 &+s25))
C114 = openmc.Cell(cell_id=114,fill=M7,region=-s33 &-s29 &+s30)
C115 = openmc.Cell(cell_id=115,fill=M6,region=-s34 &-s31 &+s29)
C116 = openmc.Cell(cell_id=116,fill=M9,region=(-s34 &-s30 &+s32)|(-s34 &+s33 &-s29 &+s30))

un.add_cells([C105,C106,C107,C108,C109,C110,C111,C112,C113,C114,C115,C116])

# add cells
C117 = openmc.Cell(cell_id=117,region=(-s999&+s22)|(-s999&+s24&-s22&+s20)|(-s999&+s28&-s20&+s26)|(-s999&-s26&+s31)|(-s999&+s34&-s31&+s32)|(-s999&-s32))
un.add_cell(C117)
