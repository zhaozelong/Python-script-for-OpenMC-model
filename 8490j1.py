...
s21  = openmc.ZPlane(   surface_id=21,    z0=6.17474 )
...
C108 = openmc.Cell(cell_id=108,region=(-s23 &+s7 &-s14 &+s19)|(-s23 &+s16 &-s18 &+s14)|(-s6 &-s18 &+s17)|(-s23 &-s22 &+s18))
...
un.add_cells([C105,C106,C108,C109,C110,C111,C112,C113,C114])
