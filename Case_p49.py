...
un.add_cells([C301,C302,C303,C304,C305,C306,C307])

C308 = openmc.Cell(cell_id=308,fill=M6,  region=(-s6& -s17 &+s12)|(-s16 &+s6 &-s18 &+s12))
C309 = openmc.Cell(cell_id=309,fill=M7,  region=(+s29 &-s15 &-s27 )|(+s15 &-s20 &-s27 &+s36) )
C310 = openmc.Cell(cell_id=310,fill=M7,  region=(+s20 &-s31 &+s24 &-s27) )
C311 = openmc.Cell(cell_id=311,fill=M9,  region=(+s26 &-s25 &-s28)|(+s27 &-s28 &-s31 &+s25) )
C312 = openmc.Cell(cell_id=312,          region=-s27 &+s25 &-s30 )
C313 = openmc.Cell(cell_id=313,fill=M9,  region=-s29 &+s30 &-s27 )
C314 = openmc.Cell(cell_id=314,          region=+s31 &-s22 &+s24 &-s28 )
C315 = openmc.Cell(cell_id=315,fill=M9,  region=(-s19 &+s20 &+s7 &-s24)|(-s24 &+s23 &+s19 &-s22) )

C316 = openmc.Cell(cell_id=316,fill=M7,  region=(+s19 &-s37 &+s36 &-s23))
C317 = openmc.Cell(cell_id=317, region=(+s37& -s14 &+s36 &-s23)|(+s14 &-s18 &+s16 &-s23)|(+s17 &-s18 &-s6)|(+s18 &-s22 &-s23) )

un.add_cells([C308, C309, C310, C311, C312, C313, C314, C315, C316, C317])

C318 = openmc.Cell(cell_id=318,         region=(+s22 &-s999)|(-s22 &+s31 &+s28 &-s999)|(+s28 &-s999 &+s26 &-s31)|(-s26 &-s999)) 
un.add_cell(C318)
