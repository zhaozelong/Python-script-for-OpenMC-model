...
###############################################################################
materials = openmc.Materials([M1, M5, M6, M7, M8, M9, M10, M11])
...
s21  = openmc.ZPlane(   surface_id=21,    z0=19.89074 )
...
trcl16 = [8.3149  , 4.8006  , 1.5875]
trcl23 = [0.0     , -3.2004 , 0]
trcl24 = [-8.3149 , -11.2014, 0]
trcl29 = [-2.7716 , -8.0010 , 0]
trcl30 = [0.0     , -6.4008 , 0]
trcl31 = [-8.3149 , -14.4018, 0]
trcl32 = [-11.0864, -12.8016, 0]
trcl33 = [-13.858 , -11.2014, 0]
trcl34 = [-16.6296, -9.6012 , 0]
trcl35 = [-5.5432 , -12.8016, 0]
trcl36 = [-2.7716 , -11.2014, 0]
trcl37 = [0.0     , -9.6012 , 0]
...
s1016 = openmc.ZCylinder(surface_id = 1016, x0 = trcl16[0]            , y0 = trcl16[1], r=1.58750)
s1023 = openmc.ZCylinder(surface_id = 1023, x0 = trcl16[0] + trcl23[0], y0 = trcl16[1] + trcl23[1], r=1.58750)
s1024 = openmc.ZCylinder(surface_id = 1024, x0 = trcl16[0] + trcl24[0], y0 = trcl16[1] + trcl24[1], r=1.58750)
s1029 = openmc.ZCylinder(surface_id = 1029, x0 = trcl16[0] + trcl29[0], y0 = trcl16[1] + trcl29[1], r=1.58750)
s1030 = openmc.ZCylinder(surface_id = 1030, x0 = trcl16[0] + trcl30[0], y0 = trcl16[1] + trcl30[1], r=1.58750)
s1031 = openmc.ZCylinder(surface_id = 1031, x0 = trcl16[0] + trcl31[0], y0 = trcl16[1] + trcl31[1], r=1.58750)
s1032 = openmc.ZCylinder(surface_id = 1032, x0 = trcl16[0] + trcl32[0], y0 = trcl16[1] + trcl32[1], r=1.58750)
s1033 = openmc.ZCylinder(surface_id = 1033, x0 = trcl16[0] + trcl33[0], y0 = trcl16[1] + trcl33[1], r=1.58750)
s1034 = openmc.ZCylinder(surface_id = 1034, x0 = trcl16[0] + trcl34[0], y0 = trcl16[1] + trcl34[1], r=1.58750)
s1035 = openmc.ZCylinder(surface_id = 1035, x0 = trcl16[0] + trcl35[0], y0 = trcl16[1] + trcl35[1], r=1.58750)
s1036 = openmc.ZCylinder(surface_id = 1036, x0 = trcl16[0] + trcl36[0], y0 = trcl16[1] + trcl36[1], r=1.58750)
s1037 = openmc.ZCylinder(surface_id = 1037, x0 = trcl16[0] + trcl37[0], y0 = trcl16[1] + trcl37[1], r=1.58750)
...
C16 = openmc.Cell(cell_id=16,fill=M10,region=-s1016 & -s8 & +s9)
C23 = openmc.Cell(cell_id=23,fill=M10,region=-s1023 & -s8 & +s9)
C24 = openmc.Cell(cell_id=24,fill=M10,region=-s1024 & -s8 & +s9)
C29 = openmc.Cell(cell_id=29,fill=M10,region=-s1029 & -s8 & +s9)
