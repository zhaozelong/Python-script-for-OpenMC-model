...
###############################################################################
materials = openmc.Materials([M1, M5, M6, M7, M8, M9, M10])
...
s21  = openmc.ZPlane(   surface_id=21,    z0=15.82674 )
...
s35  = openmc.ZCylinder(surface_id=35,     x0=5.5432 , y0=-3.2004, r=1.5875)
...
trcl29 = [5.5432  , -3.2004, 0]
trcl30 = [2.7716  , 1.6002 , 0]
trcl31 = [-5.5432 , -6.4008, 0]
trcl32 = [-8.3149 , -4.8006, 0]
trcl33 = [-11.0864, -3.2004, 0]
trcl34 = [-13.858 , -1.6002, 0]
trcl35 = [-2.7716 , -4.8006, 0]
trcl36 = [0.0     , -3.2004, 0]
trcl37 = [2.7716  , -1.6002, 0]
...
s1029 = openmc.ZCylinder(surface_id = 1029, x0 = trcl29[0]           , y0 = trcl29[1]           , r=1.58750)
s1030 = openmc.ZCylinder(surface_id = 1030, x0 = trcl29[0] + trcl30[0], y0 = trcl29[1] + trcl30[1], r=1.58750)
s1031 = openmc.ZCylinder(surface_id = 1031, x0 = trcl29[0] + trcl31[0], y0 = trcl29[1] + trcl31[1], r=1.58750)
s1032 = openmc.ZCylinder(surface_id = 1032, x0 = trcl29[0] + trcl32[0], y0 = trcl29[1] + trcl32[1], r=1.58750)
s1033 = openmc.ZCylinder(surface_id = 1033, x0 = trcl29[0] + trcl33[0], y0 = trcl29[1] + trcl33[1], r=1.58750)
s1034 = openmc.ZCylinder(surface_id = 1034, x0 = trcl29[0] + trcl34[0], y0 = trcl29[1] + trcl34[1], r=1.58750)
s1035 = openmc.ZCylinder(surface_id = 1035, x0 = trcl29[0] + trcl35[0], y0 = trcl29[1] + trcl35[1], r=1.58750)
s1036 = openmc.ZCylinder(surface_id = 1036, x0 = trcl29[0] + trcl36[0], y0 = trcl29[1] + trcl36[1], r=1.58750)
s1037 = openmc.ZCylinder(surface_id = 1037, x0 = trcl29[0] + trcl37[0], y0 = trcl29[1] + trcl37[1], r=1.58750)
...
C107 = openmc.Cell(cell_id=107,fill=M7,region=-s23 & +s7 & -s21 & +s19)
C108 = openmc.Cell(cell_id=108,region=(-s23 &+s7 &-s14 &+s21)|(-s23 &+s16 &-s18 &+s14)|(-s6 &-s18 &+s17)|(-s23 &-s22 &+s18))
