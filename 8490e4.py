...
s21  = openmc.ZPlane(   surface_id=21,    z0=18.71726 )
...
C107 = openmc.Cell(cell_id=107,fill=M7,region=(-s23 &+s7 &-s14 &+s19)|(-s23 &+s16 &-s18 &+s14))
C108 = openmc.Cell(cell_id=108,region=(-s6 &-s18 &+s17)|(-s23 &-s22 &+s18))
