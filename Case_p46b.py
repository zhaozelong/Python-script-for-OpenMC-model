...
s100 = openmc.ZPlane(   surface_id=100, z0=-8.66775 )
s101 = openmc.ZPlane(   surface_id=101, z0=-21.46427 )
s102 = openmc.ZPlane(   surface_id=102, z0=10.89025 )
...
C403 = openmc.Cell(cell_id=403, fill=M7 , region=(+s7 &-s17& -s20 &+s15)|(-s17 &+s101 &-s15) )
#C407 = openmc.Cell(cell_id=407, fill=M7, region=(+s17&-s18& +s19 &-s14) )
C408 = openmc.Cell(cell_id=408, fill=M7,  region=(+s17&-s18&-s20  &+s100) )
C409 = openmc.Cell(cell_id=409, fill=M12, region=(+s17&-s18&-s100 &+s15) )
C410 = openmc.Cell(cell_id=410, fill=M12, region=(+s17&-s18&-s15  &+s101) )
...
C507 = openmc.Cell(cell_id=507, fill=M7 , region=(+s19&-s102& +s7 &-s23) )
C508 = openmc.Cell(cell_id=508,           region=(+s102 &-s14 &+s7 &-s23) )
C509 = openmc.Cell(cell_id=509,           region=(+s14 &(+s12 |(-s12 & +s912)) &-s22 &-s23) )
C510 = openmc.Cell(cell_id=510,           region=(-s22 &+s31 &-s28 &+s24) )

C516 = openmc.Cell(cell_id=516,           region=(+s22&-s999)|(-s22 &+s31 &+s28 &-s999)|(+s28 &-s999 &+s30 &-s31)|(-s30 &-s999) )

un.add_cells([C400, C401, C403, C408, C409, C410, C500, C501, C502, C506, C507, C508, C509, C510, C516])
