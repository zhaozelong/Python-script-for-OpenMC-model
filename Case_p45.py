...
C403 = openmc.Cell(cell_id=403, fill=M7 , region=(+s7 &-s17& -s20 &+s15) )
C407 = openmc.Cell(cell_id=407, fill=M12, region=(+s17&-s18& +s19 &-s14) )
C408 = openmc.Cell(cell_id=408, fill=M12, region=(+s17&-s18& -s20 &+s15) )
C500 = openmc.Cell(cell_id=500, fill=M7 , region=(+s29&-s15& -s27)|(+s15 &-s20 &-s27 &+s18 ) )
...
C507 = openmc.Cell(cell_id=507, fill=M7 , region=(+s19&-s14& +s18 &-s23)|(+s14 &(+s12 |(-s12 & +s912)) &-s21 &-s23) )
C508 = openmc.Cell(cell_id=508,           region=(+s21&-s22& -s23) )
C509 = openmc.Cell(cell_id=509,           region=(-s22&+s31& -s28 &+s24) )
C516 = openmc.Cell(cell_id=516,           region=(+s22&-s999)|(-s22 &+s31 &+s28 &-s999)|(+s28 &-s999 &+s30 &-s31)|(-s30 &-s999) )

un.add_cells([C400, C401, C402, C403, C407, C408, C500, C501, C502, C506, C507, C508, C509, C516])
