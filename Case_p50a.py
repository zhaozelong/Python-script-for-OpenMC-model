...
s21 = openmc.ZPlane(   surface_id=21, z0=11.14425   )
...
s500  = openmc.ZCylinder(surface_id=500, r=11.98499)
...
C303 = openmc.Cell(cell_id=403,fill=M7, region=-s6 & +s10 & -s12)
C304 = openmc.Cell(cell_id=404,fill=M7, region=-s6 & -s11 & +s13)
...
C307 = openmc.Cell(cell_id=307, fill=M12, region=(+s7 &-s500 &+s19 &-s14))
C308 = openmc.Cell(cell_id=308, fill=M12, region=(+s7 &-s500 &-s20 &+s15))

C309 = openmc.Cell(cell_id=309,fill=M7,  region=(+s29 &-s15 &-s27 )|(+s15 &-s20 &-s27 &+s500) )
...
C316 = openmc.Cell(cell_id=316,fill=M7,  region=(+s19 &-s21 &+s500 &-s23))
C317 = openmc.Cell(cell_id=317, region=(+s21 &-s14 &+s500 &-s23)|(+s17 &-s18 &-s6)|(+s14 &-s18 &+s16 &-s23)|(+s18 &-s22 &-s23) )

un.add_cells([C307, C308, C309, C310, C311, C312, C313, C314, C315, C316, C317])
