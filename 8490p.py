...
C114 = openmc.Cell(cell_id=114,fill=M7,region=(-s27 &-s15 &+s25)|(-s27 &+s81 &-s75 &+s15)|(-s27 &+s7 &-s20 &+s75))
C115 = openmc.Cell(cell_id=115,fill=M9,region=(-s28 &-s25 &+s26)|(-s28 &+s27 &-s20 &+s25))
C116 = openmc.Cell(cell_id=116,fill=M7,region=-s33 &-s29 &+s30)
C117 = openmc.Cell(cell_id=117,fill=M6,region=-s34 &-s31 &+s29)
C118 = openmc.Cell(cell_id=118,fill=M9,region=(-s34 &-s30 &+s32)|(-s34 &+s33 &-s29 &+s30))

un.add_cells([C105,C106,C107,C108,C109,C110,C111,C112,C113,C114,C115,C116,C117,C118])

# add cells
C119 = openmc.Cell(cell_id=119,region=(-s999&+s22)|(-s999&+s24&-s22&+s20)|(-s999&+s28&-s20&+s26)|(-s999&-s26&+s31)|(-s999&+s34&-s31&+s32)|(-s999&-s32))
un.add_cell(C119)
