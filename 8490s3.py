...
M1.add_element('Zr'   ,  0.0352103, 'ao')
M1.add_nuclide('H1'   ,  0.0640000, 'ao')
M1.add_s_alpha_beta('c_Zr_in_ZrH')
M1.add_s_alpha_beta('c_H_in_ZrH')

# 2.00 kg borate in 39 gal of water
M2 = openmc.Material(name='boron water')
M2.temperature = 300.0
#M2.id = 2
M2.set_density('atom/b-cm', 0.1001409)
M2.add_nuclide('B10' ,  0.0000295, 'ao')
M2.add_nuclide('B11' ,  0.0001188, 'ao')
M2.add_nuclide('H1'  ,  0.0665233, 'ao')
M2.add_nuclide('N14' ,  0.0000297, 'ao')
M2.add_nuclide('O16' ,  0.0334396, 'ao')
