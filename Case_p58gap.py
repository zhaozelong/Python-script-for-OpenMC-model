...
s21 = openmc.ZPlane(   surface_id=21, z0= 22.26945   )
...
C355 = openmc.Cell(cell_id=355, fill=M30, region= (+s7  & -s509& +s600 &-s8)     )
C356 = openmc.Cell(cell_id=356, fill=M30, region= (+s7  & -s509& +s9   &-s604)     )
...
C414 = openmc.Cell(cell_id=414, fill=M7, region= (+s19 &-s8 &+s509 &-s23)|(+s8 &-s14 &-s23 &+s7)|(+s14 &-s18 &+s16 &-s23)|(+s17 &-s18 &-s6)|(+s18 &-s21 &-s23)) 
C415 = openmc.Cell(cell_id=415, region= (+s21 &-s22 &-s23) )
