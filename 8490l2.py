...
C107 = openmc.Cell(cell_id=107,fill=M3,region=(+s7 &-s79 &-s82 &+s83))
C108 = openmc.Cell(cell_id=108,fill=M2,region=(-s80 &+s79 &-s82 &+s83))
C109 = openmc.Cell(cell_id=109,fill=M3,region=(+s7 &-s81 &-s14 &+s82)|(+s7 &-s81 &+s19 &-s83)|(+s80 &-s81 &-s82 &+s83))
C110 = openmc.Cell(cell_id=110,fill=M7,region=(-s23 &+s81 &-s14 &+s19)|(-s23 &+s16 &-s18 &+s14)|(-s6 &-s18 &+s17)|(-s23 &-s21 &+s18))
...
C113 = openmc.Cell(cell_id=113,fill=M3,region=+s7 &-s79 &-s76 &+s77)
