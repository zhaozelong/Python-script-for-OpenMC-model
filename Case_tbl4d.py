...
s7  = openmc.ZCylinder(surface_id=7 , r=11.38174    )
s8  = openmc.ZPlane(   surface_id=8 , z0=15.8115    )
s9  = openmc.ZPlane(   surface_id=9 , z0=-15.8115   )
s10 = openmc.ZPlane(   surface_id=10, z0=16.129    )
s11 = openmc.ZPlane(   surface_id=11, z0=-17.0815   )

#s12 = openmc.ZPlane(   surface_id=12, z0=16.85925   )
s12 = openmc.ZCone(   surface_id=12,  z0=21.9837, r2=12.8508) # -1
s912 = openmc.ZPlane(   surface_id=912,  z0=21.9837)

s13 = openmc.ZPlane(   surface_id=13, z0=-18.8341  )
s14 = openmc.ZPlane(   surface_id=14, z0=18.8087   )
s15 = openmc.ZPlane(   surface_id=15, z0=-19.4691  )
#s16 = openmc.ZCylinder(surface_id=16, r=16.46555    )
s16 = openmc.ZCone(   surface_id=16,  z0=21.90496, r2=13.3262) # -1
s916 = openmc.ZPlane(   surface_id=916,  z0=21.90496) # -1

s17 = openmc.ZCylinder( surface_id=17, r=12.01674   )
s18 = openmc.ZCylinder( surface_id=18, r=12.65174   )
s19 = openmc.ZPlane(   surface_id=19, z0=6.01218   )
s20 = openmc.ZPlane(   surface_id=20, z0=5.8547    )
#s21 = openmc.ZPlane(   surface_id=21, z0=30.9499   )
...
s27 = openmc.ZCylinder(surface_id=27, r=34.24174      )
s28 = openmc.ZCylinder(surface_id=28, r=34.3992    )
s29 = openmc.ZPlane(   surface_id=29, z0=-33.7439  )
s30 = openmc.ZPlane(   surface_id=30, z0=-34.0614  )
...
s100 = openmc.ZPlane(   surface_id=100, z0=-3.00355  )
s101 = openmc.ZPlane(   surface_id=101, z0=-28.32735)
s102 = openmc.ZPlane(   surface_id=102, z0=30.82925 )
...
C31 = openmc.Cell(cell_id=31,fill=u85 , region=-s1031 & -s8 & +s9)
C32 = openmc.Cell(cell_id=32,fill=u84 , region=-s1032 & -s8 & +s9)
...
C303 = openmc.Cell(cell_id=303,        region=(-s6 &+s10 &-s14)|(+s14 &-s16 & -s916))
C304 = openmc.Cell(cell_id=304,        region=-s6 & -s11 & +s13)
...
un.add_cells([C301,C302,C303,C304])

C400 = openmc.Cell(cell_id=400, fill=M9 , region=(-s7 &+s6 & -s14 &+s13)|(-s12 & -s912 &(+s16 |(-s16 & +s916)) &+s14) )
C401 = openmc.Cell(cell_id=401, fill=M6 , region=(-s7 &+s15& -s13) )
#C402 = openmc.Cell(cell_id=402, fill=M7 , region=(+s7 &-s17& +s19 &-s14))
C403 = openmc.Cell(cell_id=403, fill=M7 , region=(+s7 &-s18& -s20 &+s100) )
#C407 = openmc.Cell(cell_id=407, fill=M12, region=(+s17&-s18& +s19 &-s14) )
#C408 = openmc.Cell(cell_id=408, fill=M12, region=(+s17&-s18& -s20 &+s15) )
C409 = openmc.Cell(cell_id=409, fill=M12, region= (+s17 &-s18 &-s100 &+s101) )
C410 = openmc.Cell(cell_id=410, fill=M7 , region= (+s7 &-s17 &-s100 &+s101) )
C411 = openmc.Cell(cell_id=411, fill=M7 , region= (-s7 &+s101 &-s15) )

C500 = openmc.Cell(cell_id=500, fill=M7 , region=(+s29&-s101& -s27)|(+s101 &-s20 &-s27 &+s18 ) )
C501 = openmc.Cell(cell_id=501, fill=M7 , region=(-s27&+s24& +s20 &-s31) )
C502 = openmc.Cell(cell_id=502, fill=M9 , region=(-s29&-s28& +s30)|(+s27 &-s28 &+s29 &-s31) )
C506 = openmc.Cell(cell_id=506, fill=M9 , region=(-s19&+s20& +s7 & -s24)|(-s24 &+s23 &+s19 &-s22))
C507 = openmc.Cell(cell_id=507, fill=M7 , region=(+s19&-s14& +s7 &-s23))
C509 = openmc.Cell(cell_id=509, fill=M7 , region=(+s14 &(+s12 |(-s12 & +s912)) &-s102 &-s23))
C510 = openmc.Cell(cell_id=510,           region=(+s102&-s22& -s23) )
C511 = openmc.Cell(cell_id=511,           region=(-s22&+s31& -s28 &+s24) )
C516 = openmc.Cell(cell_id=516,           region=(+s22&-s999)|(-s22 &+s31 &+s28 &-s999)|(+s28 &-s999 &+s30 &-s31)|(-s30 &-s999) )

un.add_cells([C400, C401, C403, C409, C410, C411, C500, C501, C502, C506, C507, C509, C510, C511, C516])
