...
C109 = openmc.Cell(cell_id=109,fill=M7,region=(-s23 &+s81 &-s14 &+s19)|(-s23 &+s16 &-s18 &+s14)|(-s6 &-s18 &+s17)|(-s23 &-s21 &+s18))
...
C112 = openmc.Cell(cell_id=112,fill=M12,region=(-s81 &+s7 &-s20 &+s15))
C113 = openmc.Cell(cell_id=113,fill=M7,region=(-s27 &-s15 &+s25)|(-s27 &+s81 &-s20 &+s15))
...
un.add_cells([C105,C106,C107,C109,C110,C111,C112,C113,C114,C115,C116,C117])
