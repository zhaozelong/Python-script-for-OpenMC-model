...
s13 = openmc.ZPlane(   surface_id=13, z0=-16.71357  )
s14 = openmc.ZPlane(   surface_id=14, z0=16.70177   )
s15 = openmc.ZPlane(   surface_id=15, z0=-16.79231  )
...
s19 = openmc.ZPlane(   surface_id=19, z0=16.54429   )
s20 = openmc.ZPlane(   surface_id=20, z0=8.60425    )
s22 = openmc.ZPlane(   surface_id=22, z0=32.73769   )
...
s25 = openmc.ZPlane(   surface_id=25, z0=-44.09731  )
s26 = openmc.ZPlane(   surface_id=26, z0=-44.41481  )
s27 = openmc.ZCylinder(surface_id=27, r=34.925      )
s28 = openmc.ZCylinder(surface_id=28, r=35.08248    )
s29 = openmc.ZPlane(   surface_id=29, z0=-36.15981  )
s30 = openmc.ZPlane(   surface_id=30, z0=-36.47731  )
s31 = openmc.ZPlane(   surface_id=31, z0=17.49769   )
...
s999 = openmc.Sphere(   surface_id=999, r=58       , boundary_type = 'vacuum')
...
C7  = openmc.Cell(cell_id=7 ,fill=u2  , region=-s1007 & -s8 & +s9)
...
C13 = openmc.Cell(cell_id=13,fill=u2  , region=-s1013 & -s8 & +s9)
...
C20 = openmc.Cell(cell_id=20,fill=u2  , region=-s1020 & -s8 & +s9)
...
C24 = openmc.Cell(cell_id=24,fill=u2  , region=-s1024 & -s8 & +s9)
C25 = openmc.Cell(cell_id=25,fill=u2  , region=-s1025 & -s8 & +s9)
C26 = openmc.Cell(cell_id=26,fill=u512, region=-s1026 & -s8 & +s9)
C27 = openmc.Cell(cell_id=27,fill=u2  , region=-s1027 & -s8 & +s9)
...
C35 = openmc.Cell(cell_id=35,fill=u2  , region=-s1035 & -s8 & +s9)
C34 = openmc.Cell(cell_id=34,fill=u2  , region=-s1034 & -s8 & +s9)
C33 = openmc.Cell(cell_id=33,fill=u2  , region=-s1033 & -s8 & +s9)
...
# add cells
C401 = openmc.Cell(cell_id=401,fill=M6,region=-s6 & +s8  & -s10)
C402 = openmc.Cell(cell_id=402,fill=M6,region=-s6 & -s9  & +s11)
C403 = openmc.Cell(cell_id=403,        region=-s6 & +s10 & -s12)
C404 = openmc.Cell(cell_id=404,        region=-s6 & -s11 & +s13)
C405 = openmc.Cell(cell_id=405,fill=M9,region=(-s7 & -s13 & +s15)|(-s7 & +s6 & -s14 & +s13)|(-s16 & +s6 & -s12 & +s14))
C406 = openmc.Cell(cell_id=406,fill=M6,region=(-s6 & -s17 & +s12)|(-s16 & +s6 &-s18 &+s12))
un.add_cells([C401,C402,C403,C404,C405,C406])

C407 = openmc.Cell(cell_id=407, fill=M11, region=(+s7&-s301&+s302&-s300&+s303 &-s20 &+s502 &+s208 &+s202 &+s211 &+s205) )
C408 = openmc.Cell(cell_id=408, fill=M11, region=(+s7&-s301&+s302&-s300&+s303 &-s503 &+s20 &+s208 &+s202 &+s211 &+s205) )
C409 = openmc.Cell(cell_id=409, fill=M11, region=(+s7&-s504&+s500&-s503&-s202)                        )
C410 = openmc.Cell(cell_id=410, fill=M11, region=(+s7&-s504&+s500&-s503&-s205)                        )
C411 = openmc.Cell(cell_id=411, fill=M11, region=(+s7&-s504&+s500&-s503&-s208)                        )
C412 = openmc.Cell(cell_id=412, fill=M11, region=(+s7&-s504&+s500&-s503&-s211)                        )
C413 = openmc.Cell(cell_id=413, fill=M11, region=(+s7&-s504&+s502&-s501&-s202)                        )
C414 = openmc.Cell(cell_id=414, fill=M11, region=(+s7&-s504&+s502&-s501&-s205)                        )
C415 = openmc.Cell(cell_id=415, fill=M11, region=(+s7&-s504&+s502&-s501&-s208)                        )
C416 = openmc.Cell(cell_id=416, fill=M11, region=(+s7&-s504&+s502&-s501&-s211)                        )

C420 = openmc.Cell(cell_id=420, fill=M9, region= (+s501 & -s506 & -s200) )
C422 = openmc.Cell(cell_id=422, fill=M9, region= (-s505 & +s506 & -s201) )
C423 = openmc.Cell(cell_id=423, fill=M9, region= (+s501 & -s506 & -s203) )
C425 = openmc.Cell(cell_id=425, fill=M9, region= (-s505 & +s506 & -s204) )
C426 = openmc.Cell(cell_id=426, fill=M9, region= (+s501 & -s506 & -s206) )
C428 = openmc.Cell(cell_id=428, fill=M9, region= (-s505 & +s506 & -s207) )
C429 = openmc.Cell(cell_id=429, fill=M9, region= (+s501 & -s506 & -s209) )
C431 = openmc.Cell(cell_id=431, fill=M9, region= (-s505 & +s506 & -s210) )

C440 = openmc.Cell(cell_id=440, fill=M11, region= (+s401& -s205 &+s501&-s20 &+s204)  )
C441 = openmc.Cell(cell_id=441, fill=M11, region= (-s202& -s403 &+s501&-s20 &+s201)  )
C442 = openmc.Cell(cell_id=442, fill=M11, region= (-s208& -s403 &+s501&-s20 &+s207)  )
C443 = openmc.Cell(cell_id=443, fill=M11, region= (-s211& +s401 &+s501&-s20 &+s210)  )
C444 = openmc.Cell(cell_id=444, fill=M11, region= (+s401& -s205 &+s20 &-s500&+s204)  )
C445 = openmc.Cell(cell_id=445, fill=M11, region= (-s202& -s403 &+s20 &-s500&+s201)  )
C446 = openmc.Cell(cell_id=446, fill=M11, region= (-s208& -s403 &+s20 &-s500&+s207)  )
C447 = openmc.Cell(cell_id=447, fill=M11, region= (-s211& +s401 &+s20 &-s500&+s210)  )

C460 = openmc.Cell(cell_id=460, fill=M7, region= (+s29 & -s15 & -s27 )  )
C461 = openmc.Cell(cell_id=461, fill=M7, region= (+s7  & -s27 & -s502 & +s15))

C463 = openmc.Cell(cell_id=463, fill=M7, region= (+s7  & -s27 & +s502 & -s20))
COMB_01_REG =  C407.region | C413.region | C414.region | C415.region | C416.region
COMB_01_REG =  COMB_01_REG | C440.region | C441.region | C442.region | C443.region
COMB_01_REG =  COMB_01_REG | C420.region | C422.region | C423.region | C425.region | C426.region
COMB_01_REG =  COMB_01_REG | C428.region | C429.region | C431.region
C463.region = C463.region & (~COMB_01_REG)

C464 = openmc.Cell(cell_id=464, region = (+s20 &-s503 &-s27 &+s7) )
COMB_02_REG =  C408.region | C409.region | C410.region | C411.region | C412.region
COMB_02_REG =  COMB_02_REG | C444.region | C445.region | C446.region | C447.region
C464.region = C464.region & (~COMB_02_REG)

C466 = openmc.Cell(cell_id=466,         region=(-s19 &+s503 &-s27 &+s7) )
C467 = openmc.Cell(cell_id=467,         region=(+s19 &-s31 &+s24 &-s27) )
C470 = openmc.Cell(cell_id=470,fill=M9, region=(+s26 &-s25 &-s28)|(+s27 &-s28 &-s31 &+s25) )
C471 = openmc.Cell(cell_id=471,         region=-s27 &+s25 &-s30 )
C472 = openmc.Cell(cell_id=472,fill=M9, region=-s29 &+s30 &-s27 )
C473 = openmc.Cell(cell_id=473,         region=+s31 &-s22 &+s24 &-s28 )
C481 = openmc.Cell(cell_id=481,fill=M9, region=(-s14 &+s19 &+s7 &-s24)|(-s24 &+s23 &+s19 &-s22) )
C482 = openmc.Cell(cell_id=482,fill=M7, region=(+s14 &-s18 &+s16 &-s23)|(+s17 &-s18 &-s6)|(+s18 &-s36 &-s23) )
C483 = openmc.Cell(cell_id=483,         region=(-s23 &+s36 &-s22) )
C500 = openmc.Cell(cell_id=500,         region=(+s22 &-s999)|(-s22 &+s31 &+s28 &-s999)|(+s28 &-s999 &+s26 &-s31)|(-s26 &-s999)) 

un.add_cells([C407, C408, C409, C410, C411, C412, C413, C414, C415, 
   C416, C420, C422, C423, C425, C426, C428, C429, C431, 
   C440, C441, C442, C443, C444, C445, C446, C447, C460, 
   C461, C463, C464, C466, C467, C470, C471, C472, C473, 
   C481, C482, C483, C500 ])
