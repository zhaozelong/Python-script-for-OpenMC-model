...
s500 = openmc.ZCylinder(surface_id=500, r= 11.42873)
s501 = openmc.ZCylinder(surface_id=501, r= 18.89125)
s502 = openmc.ZCylinder(surface_id=502, r= 18.96999)
s503 = openmc.ZCylinder(surface_id=503, r= 19.04873)
s504 = openmc.ZCylinder(surface_id=504, r= 21.43125)
s505 = openmc.ZCylinder(surface_id=505, r= 21.50999)
s506 = openmc.ZCylinder(surface_id=506, r= 22.14499)
...
#C306 = openmc.Cell(cell_id=306,fill=M12, region=(+s15 &-s20 &+s7 &-s36))
#C307 = openmc.Cell(cell_id=307,fill=M12, region=(+s19 &-s14 &+s7 &-s36))
un.add_cells([C301,C302,C303,C304,C305])

# c --------sleeve assembly-----------------------$
C306 = openmc.Cell(cell_id=306, fill=M6 , region=(-s6 &-s17 &+s12)|(-s16 &+s6 &-s18 &+s12) )
C307 = openmc.Cell(cell_id=307, fill=M35, region=(+s7 &-s500 &-s601 &+s602)          )
C308 = openmc.Cell(cell_id=308, fill=M35, region=(+s7 &-s500 &+s605 &-s603)          )
C309 = openmc.Cell(cell_id=309,           region=(+s500&-s501&+s602&-s601)        )
C310 = openmc.Cell(cell_id=310,           region=(+s500&-s501&+s605&-s603)        )
C311 = openmc.Cell(cell_id=311, fill=M35, region=(+s501&-s503&+s602&-s601)        )
C312 = openmc.Cell(cell_id=312, fill=M35, region=(+s501&-s503&+s605&-s603)        )
C313 = openmc.Cell(cell_id=313, fill=M20, region=(+s503&-s504&+s602&-s601)        )
C314 = openmc.Cell(cell_id=314, fill=M20, region=(+s503&-s504&+s605&-s603)        )
C315 = openmc.Cell(cell_id=315, fill=M35, region=(+s504&-s506&+s602&-s601)        )
C316 = openmc.Cell(cell_id=316, fill=M35, region=(+s504&-s506&+s605&-s603)        )
C317 = openmc.Cell(cell_id=317, fill=M35, region=(-s605 &+s604 &+s7 &-s506)          )
C318 = openmc.Cell(cell_id=318, fill=M35, region=(+s19 &-s602 &+s7 &-s506)           )
C319 = openmc.Cell(cell_id=319, fill=M35, region=(+s601 &-s600 &+s7 &-s506)          )
C320 = openmc.Cell(cell_id=320, fill=M35, region=(+s603 &-s20 &+s7 &-s506)           )
C321 = openmc.Cell(cell_id=321, fill=M7, region=(+s7 &-s506 &+s600 &-s8)            )
C322 = openmc.Cell(cell_id=322, fill=M7, region=(+s7 &-s506 &+s9 &-s604)            )
# c ----------- water tanks -----------------------------------$
C407 = openmc.Cell(cell_id=407, fill=M7, region= (+s29 &-s15 &-s27)|(+s9 &-s20 &-s27 &+s506)|(-s27 &+s7 &+s15 &-s9) )
...
C414 = openmc.Cell(cell_id=414, fill=M7, region= (+s19 &-s8 &+s506 &-s23)|(+s8 &-s21 &-s23 &+s7)) 
C415 = openmc.Cell(cell_id=415, region= (+s21 &-s14 &+s7 &-s23)|(+s14 &-s18 &+s16 &-s23)|(+s18 &-s22 &-s23)|(+s17 &-s18 &-s6) )

un.add_cells([C306, C307, C308, C309, C310, C311, C312, C313, C314, C315, C316, C317, C318, C319, C320, C321, C322])
