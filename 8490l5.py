...
C109 = openmc.Cell(cell_id=109,fill=M7,region=(-s23 &+s7 &-s14 &+s19)|(-s23 &+s16 &-s18 &+s14)|(-s6 &-s18 &+s17)|(-s23 &-s21 &+s18))
C110 = openmc.Cell(cell_id=110,region=-s23 &-s22 &+s21)
C111 = openmc.Cell(cell_id=111,fill=M9,region=(-s24 &+s7 &-s19 &+s20)|(-s24 &+s23 &-s22 &+s19))

C112 = openmc.Cell(cell_id=112,fill=M12,region=(-s81 &+s7 &-s20 &+s78))
...
un.add_cells([C105,C106,C109,C110,C111,C112,C113,C114,C115,C116,C117])
