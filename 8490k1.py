...
###############################################################################
materials = openmc.Materials([M1, M2, M3, M5, M6, M7, M8, M9, M10, M11])
...
s75  = openmc.ZPlane(surface_id=75, z0=6.01726 )
s76  = openmc.ZPlane(surface_id=76, z0=5.93852 )
s77  = openmc.ZPlane(surface_id=77, z0=-5.334  )
s78  = openmc.ZPlane(surface_id=78, z0=-5.41274)
s79  = openmc.ZCylinder(surface_id=79, r=11.46429)
s80  = openmc.ZCylinder(surface_id=80, r=12.57681)
s81  = openmc.ZCylinder(surface_id=81, r=12.65555)
...
# CELLS define
# cell: 100
C100 = openmc.Cell(cell_id=100,region=-s6 & -s8 & +s9)
...
trcl33 = [-5.5432, -16.0020, 0]
trcl34 = [-8.3149, -14.4018, 0]
trcl35 = [2.7716 , -17.6022, 0]
trcl36 = [5.5432 , -16.0020, 0]
...
C30 = openmc.Cell(cell_id=30,fill=u1,region=-s1030 & -s8 & +s9)
C31 = openmc.Cell(cell_id=31,fill=u1,region=-s1031 & -s8 & +s9)
C32 = openmc.Cell(cell_id=32,fill=u1,region=-s1032 & -s8 & +s9)
C33 = openmc.Cell(cell_id=33,fill=u1,region=-s1033 & -s8 & +s9)
C34 = openmc.Cell(cell_id=34,fill=u1,region=-s1034 & -s8 & +s9)
C35 = openmc.Cell(cell_id=35,fill=u1,region=-s1035 & -s8 & +s9)
C36 = openmc.Cell(cell_id=36,fill=u1,region=-s1036 & -s8 & +s9)
...
C103 = openmc.Cell(cell_id=103,region=-s6 & +s10 & -s12)
C104 = openmc.Cell(cell_id=104,region=-s6 & -s11 & +s13)
...
C110 = openmc.Cell(cell_id=110,fill=M3,region=+s7 &-s79 &+s77 &-s76)

C111 = openmc.Cell(cell_id=111,fill=M2,region=-s80 &+s79 &-s76 &+s77)
C112 = openmc.Cell(cell_id=112,fill=M3,region=(+s7 &-s81 &+s76 &-s75)|(-s76 &+s80 &-s81 &+s77)|(+s7 &-s81 &+s78 &-s77))
C113 = openmc.Cell(cell_id=113,fill=M7,region=(-s27 &-s15 &+s25)|(-s27 &+s7 &-s78 &+s15)|(-s27 &+s81 &-s20 &+s78))
C114 = openmc.Cell(cell_id=114,fill=M9,region=(-s28 &-s25 &+s26)|(-s28 &+s27 &-s20 &+s25))
C115 = openmc.Cell(cell_id=115,fill=M7,region=-s33 &-s29 &+s30)
C116 = openmc.Cell(cell_id=116,fill=M6,region=-s34 &-s31 &+s29)
C117 = openmc.Cell(cell_id=117,fill=M9,region=(-s34 &-s30 &+s32)|(-s34 &+s33 &-s29 &+s30))

un.add_cells([C105,C106,C107,C108,C109,C110,C111,C112,C113,C114,C115,C116,C117])

# add cells
C118 = openmc.Cell(cell_id=118,region=(-s999&+s22)|(-s999&+s24&-s22&+s20)|(-s999&+s28&-s20&+s26)|(-s999&-s26&+s31)|(-s999&+s34&-s31&+s32)|(-s999&-s32))
un.add_cell(C118)
