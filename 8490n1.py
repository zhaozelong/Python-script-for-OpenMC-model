...
C109 = openmc.Cell(cell_id=109,fill=M3, region=(+s7 &-s81 &+s19 &-s83)|(+s7 &-s81 &+s82 &-s14)|(+s83 &-s82 &+s80 &-s81))
...
C116 = openmc.Cell(cell_id=116,fill=M7,region=(-s27 &-s15 &+s25)|(-s27 &+s81 &-s75 &+s15))
